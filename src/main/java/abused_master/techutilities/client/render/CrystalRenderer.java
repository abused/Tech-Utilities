...
public class CrystalRenderer extends BlockEntityRenderer<TileEntityEnergyCrystal> {

    @Override
    public void render(TileEntityEnergyCrystal tile, double x, double y, double z, float float_1, int int_1) {
