...
public class ModRecipes {
    ...
    public static RecipeGenerator registerRecipes() {
        RecipeGenerator generator =  new RecipeGenerator($ -> {
            ...
            $.createShaped(new ItemStack(ModBlocks.MOB_GRINDER), null, new RecipeGenerator.ShapedParser("SCS", "DND", "SCS", 'S', Blocks.WITHER_SKELETON_SKULL, 'C', ModBlocks.PHASE_CELL, 'D', Items.DIAMOND_SWORD));
            ...
            $.createShaped(new ItemStack(ModBlocks.PHASE_CELL), null, new RecipeGenerator.ShapedParser("PLPee", "GRG", "PLP", 'P', EnumResourceItems.PHASE_INGOT.getItemIngot(), 'L', Items.LAPIS_LAZULI, 'G', Blocks.GLASS, 'R', Blocks.REDSTONE_BLOCK));
            ...
            $.createShaped(new ItemStack(ModBlocks.ENERGY_CRYSTAL), null, new RecipeGenerator.ShapedParser("GPG", "GPG", "GPG", 'G', Items.GOLD_INGOT, 'P', EnumResourceItems.PHASE_INGOT));
            ...
            $.createShaped(new ItemStack(ModItems.LINKER), null, new RecipeGenerator.ShapedParser("P P", " P ", " P ", 'P', EnumResourceItems.PHASE_INGOT));
