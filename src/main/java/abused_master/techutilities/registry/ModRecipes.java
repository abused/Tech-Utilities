...
public class ModRecipes {
    ...
    public static void registerRecipes() {
        ...
        RecipeGenerator.createShaped(new ItemStack(BlockResources.EnumResourceBlocks.SILVER_BLOCK.getBlockOres()), null, new RecipeGenerator.ShapedParser("XXX", "XXX", "XXX", 'X', EnumResourceItems.SILVER_INGOT.getItemIngot()));
        RecipeGenerator.createShaped(new ItemStack(BlockResources.EnumResourceBlocks.NICKEL_BLOCK.getBlockOres()), null, new RecipeGenerator.ShapedParser("XXX", "XXX", "XXX", 'X', EnumResourceItems.NICKEL_INGOT.getItemIngot()));
